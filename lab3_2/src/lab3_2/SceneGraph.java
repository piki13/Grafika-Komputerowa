...
public class SceneGraph extends JPanel {
	...
	private void createWorld() {
		...
		Polygon_1  = new TransformedObject(Penta);
		Polygon_2  = new TransformedObject(Penta);
		Polygon_3  = new TransformedObject(Penta);
		Polygon_4  = new TransformedObject(Penta);
		Polygon_5  = new TransformedObject(Penta);
		Polygon_6  = new TransformedObject(Penta);
		
		Triangle_1.setScale(0.7, 2).setTranslation(0, -2.9).setColor(Color.BLUE);
		Triangle_2.setScale(0.5, 1.43).setTranslation(-2.25, 0.2).setColor(new Color(128, 0, 128));
		Triangle_3.setScale(0.35, 1).setTranslation(1.5, 0.8).setColor(new Color(0,128,0));
		Line_1.setRotation(-18).setScale(2.5, 0.2).setTranslation(0, -0.9).setColor(Color.RED);
		Line_2.setRotation(-18).setScale(1.8, 0.14).setTranslation(-2.2,1.6).setColor(Color.RED);
		Line_3.setRotation(-18).setScale(1.25, 0.1).setTranslation(1.5, 1.8).setColor(Color.RED);
		Polygon_1.setScale(0.3, 0.3).setTranslation(-1.15, -0.5).setColor(Color.BLACK);;
		Polygon_2.setScale(0.3, 0.3).setTranslation(1.15, -1.25).setColor(Color.BLACK);;
		Polygon_3.setScale(0.22, 0.22).setTranslation(-3, 1.86).setColor(Color.BLACK);;
		Polygon_4.setScale(0.22, 0.22).setTranslation(-1.4, 1.33).setColor(Color.BLACK);;
		Polygon_5.setScale(0.15, 0.15).setTranslation(0.95, 1.99).setColor(Color.BLACK);;
		Polygon_6.setScale(0.15, 0.15).setTranslation(2.05, 1.63).setColor(Color.BLACK);;
	...
	//....................................................................................................................................
    private static SceneGraphNode Penta = new SceneGraphNode()
    		{
    	void doDraw(Graphics2D g){
